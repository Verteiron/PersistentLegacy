...
public:
	...
	virtual bool	Unk_64(void);
	virtual bool	Unk_65(void);
	virtual bool	Unk_66(void);
	virtual bool	Unk_67(void);
	virtual bool	Unk_68(void);
	virtual bool	Unk_69(void);
	virtual bool	Unk_6A(void);
	virtual bool 	Unk_6B(void);
	virtual bool	Unk_6C(void);
	virtual void	SetNiNode(NiNode * root, UInt32 unk1); // NULL, 1?
	virtual bool	Unk_6E(void);
	virtual NiNode	* GetNiRootNode(UInt32 firstPerson);
	virtual NiNode	* GetNiNode(void);	// Root of the skeleton (Get3D)
	virtual bool	Unk_71(void);
	virtual bool	Unk_72(void);
	virtual bool	Unk_73(void);
	virtual bool	Unk_74(void);
	virtual bool	Unk_75(void);
	virtual bool	Unk_76(void);
	virtual bool	Unk_77(void);
	virtual bool	Unk_78(void);
	virtual bool	Unk_79(void);
	virtual bool	Unk_7A(void);
	virtual bool	Unk_7B(void);
	virtual bool	Unk_7C(void);
	virtual bool	Unk_7D(void);
	virtual ActorWeightModel	* GetWeightModel(UInt32 weightModel); // 0 Small 1 Large
	virtual bool	Unk_7F(void);
	virtual bool	Unk_80(void);
	virtual bool	Unk_81(void);
	virtual bool	Unk_82(void);
	virtual bool	Unk_83(void);
	virtual bool	Unk_84(void);
	virtual bool	Unk_85(void);
	virtual bool	Unk_86(void);
	virtual bool	Unk_87(void);
	virtual bool	Unk_88(void);
	virtual void	ResetInventory(bool unk);
	virtual bool	Unk_8A(void);
	virtual bool	Unk_8B(void);
	virtual bool	Unk_8C(void);
	virtual bool	Unk_8D(void);
	virtual bool	Unk_8E(void);
	virtual bool	Unk_8F(void);
	virtual bool	Unk_90(void);
	virtual bool	Unk_91(void);
	virtual bool	Unk_92(void);
	virtual bool	Unk_93(void);
	virtual bool	Unk_94(void);
	virtual bool	Unk_95(void);
	virtual bool	Unk_96(void);
	virtual bool	Unk_97(void);
	virtual bool	Unk_98(void);
	virtual bool	IsDead(UInt8 unk1); // unk1 = 1 for Actors
	virtual bool	Unk_9A(void);
	virtual bool	Unk_9B(void);
